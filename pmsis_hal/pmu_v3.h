...
#include "maestro_periph.h"

#define IP_WRITE(addr,offset,value) (hal_write32((addr)+(offset), value))
#define IP_READ(addr,offset) (hal_read32((addr)+(offset)))
...
#define PMU_WRITE(offset, value) IP_WRITE(PMU_ADDR, offset, value)
#define PMU_READ(offset) IP_READ(PMU_ADDR, offset)
