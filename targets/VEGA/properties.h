...
#define UDMA_I2C_ID(id)             (7   + (id))
#define UDMA_HYPER_ID(id)           (8   + (id))
#define UDMA_JTAG_FIFO_ID(id)       (9   + (id))
#define UDMA_SDIO_ID(id)            (10  + (id))
#define UDMA_I2S_ID(id)             (11  + (id))
#define UDMA_CAM_ID(id)             (12  + (id))
#define UDMA_CSI2_ID(id)            (13  + (id))
#define UDMA_MRAM_ID(id)            (14  + (id))
#define UDMA_FILTER_ID(id)          (15  + (id))
#endif
